...
def transform_dict_to_model(data_dict):
    ...
    for item in data_dict:
        property = Property(
            ...
            bed=int(float(item["bedrooms"])) if item["bedrooms"] != "" else None,
            ...
            livingArea=float(item["livingArea"]) if item["livingArea"] != "" else None,
            zestimate=float(item["zestimate"]) if item["zestimate"] != "" else None,
